...
class SmoothBottomBar : View {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        barCornerRadius =
            typedArray.getDimension(R.styleable.SmoothBottomBar_cornerRadius, this.barCornerRadius)
        itemPadding =
    ...
    private fun setActionItemV2(position: Int) {
    ...
    private fun animateAlphaV2(item: BottomBarItem, to: Int) {
